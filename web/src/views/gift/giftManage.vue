...
<template>
  <div class="app-container">
    ...
    <el-table  :data="list" size="small" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="礼物名称" prop="giftName"/>

      <el-table-column align="center" label="礼物价格" prop="giftPrice"/>
...
export default {
  ...
  methods: {
    getList() {
      ...
      getAll("/AdminGift/giftList",this.listQuery).then(response=>{
