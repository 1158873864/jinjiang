...
<template>
  <div class="app-container">
    ...
    <el-table  :data="list" size="small" border fit highlight-current-row>
      ...
      <el-table-column align="center" property="discountId" label="赠送优惠卷"/>
...
-->
  ...
  <el-form ref="editForm" label-width="100px" status-icon label-position="left"  style="width: 400px; margin-left:50px;">
    ...
    <el-form-item label="赠送优惠卷" prop="discountId">
      <el-select v-model="editForm.discountId">
        <el-option v-for="item in discount" :key="item.id" :label="item.name" :value="item.name"/>
      </el-select>
    </el-form-item>
