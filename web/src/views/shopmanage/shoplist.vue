<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      <el-table-column align="center" width="100px" label="酒庄编号" prop="id" sortable/>

      <el-table-column align="center" label="酒庄名称" prop="name"/>

      <el-table-column align="center" label="酒庄电话" prop="mobilePhone"/>

      <el-table-column align="center" label="酒庄营业时间" prop="workTime"/>

      <el-table-column align="center" label="省" prop="province"/>

      <el-table-column align="center" label="市" prop="city"/>

      <el-table-column align="center" label="区" prop="district"/>

      <el-table-column align="center" label="详细地址" prop="detail"/>

      <el-table-column align="center" label="酒庄余额" prop="balance"/>

      <el-table-column align="center" property="faceUrl" label="酒庄头像">
        <template slot-scope="scope">
          <img v-if="scope.row.faceUrl" :src="scope.row.faceUrl" width="40">
        </template>
      </el-table-column>

      <el-table-column align="center" property="showUrl" label="酒庄展示图">
        <template slot-scope="scope">
          <img v-if="scope.row.showUrl" :src="scope.row.showUrl" width="40">
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="酒庄电话" prop="mobilePhone">
          <el-input v-model="dataForm.mobilePhone"/>
        </el-form-item>

        <el-form-item label="酒庄营业时间" prop="workTime">
          <el-input v-model="dataForm.workTime"/>
        </el-form-item>

        <el-form-item label="所属区域" prop="region">
          <v-distpicker :province="dataForm.province" :city="dataForm.city" :area="dataForm.district" @selected="onSelected" @province="onChangeProvince" @city="onChangeCity" @area="onChangeArea" ></v-distpicker>
        ...
        <el-form-item label="酒庄余额" prop="balance">
          <el-input v-model="dataForm.balance"/>
        </el-form-item>

        <el-form-item label="酒庄头像" prop="dataForm.faceUrl">
          <el-upload
            :action="uploadPath"
        ...
        <el-form-item label="酒庄展示图" prop="dataForm.showUrl">
          <el-upload
            :action="uploadPath"
            :show-file-list="false"
            :on-success="uploadshowUrl"
            class="avatar-uploader"
            accept=".jpg,.jpeg,.png,.gif">
            <img v-if="dataForm.showUrl" :src="dataForm.showUrl" class="avatar">
            <i v-else class="el-icon-plus avatar-uploader-icon"/>
          </el-upload>
        </el-form-item>
